...
const STATUS_STYLES = {
  ...
  confirmed: { color: "bg-blue-100 text-blue-700", label: "Confirmed", icon: <CheckCircle size={14} /> },
  preparing: { color: "bg-orange-100 text-orange-700", label: "Preparing", icon: <CookingPot size={14} /> },
  arriving: { color: "bg-purple-100 text-purple-700", label: "Arriving", icon: <Truck size={14} /> },
  delivered: { color: "bg-green-100 text-green-700", label: "Delivered", icon: <CheckCircle size={14} /> },
};
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 overflow-hidden w-full">
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 p-4">
        ...
        <div className="flex-1">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
            <h3 className="font-semibold text-lg text-gray-800">{order.restaurant}</h3>
            <div
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center sm:justify-end p-4 border-t border-gray-100">
        ...
        <button className="w-full sm:w-auto sm:min-w-[120px] py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg font-semibold text-sm transition-all">
          Reorder
        </button>
      </div>
    </div>
