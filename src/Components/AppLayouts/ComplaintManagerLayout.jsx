...
const ComplaintManagerLayout = ({ children, showSidebar }) => {
  const [isMobileSidebarOpen, setIsMobileSidebarOpen] = useState(false);

  const items = [
    { title: "Restaurants", icon: <Store />, destination: "/cm/restaurants" },
    { title: "Customers", icon: <Users />, destination: "/cm/customers" },
    { title: "Complaints", icon: <TriangleAlert />, destination: "/cm/complaints" },
  ];
...
export default ComplaintManagerLayout;
